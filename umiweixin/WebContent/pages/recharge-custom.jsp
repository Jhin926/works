    ...
    <li class="bank-info">
      <p class="left">
    		<span class="radio checked">
    			<input type="radio" checked="checked" name="aim" value="bank"/>
    		</span>
      </p>
  ...
  $(function () {
    ...
    $(".recharge").on("touchend", function () {
      ...
      var url = "chongZhiAction!asseAmount.action",
          data = {"srcID": 200, "dstID": 888, "amount": getAmount},
          jumpHref = "pages/chongzhi-yanzheng.jsp";

      if($(".radio").index($(".radio.checked")) != 0){
        var srcID = $(".radio.checked").parents("li").attr("data-accId"),
          finaAccId = $(".radio.checked").parents("li").attr("data-finaAccId"),
          timeLimit = location.search.substring(11);

        url = "detail!transfer.action";
        data = {"srcID": srcID, "dstID": 888, "amount": getAmount, "finaAccId": finaAccId, "timeLimit": timeLimit, "accountID":888};
