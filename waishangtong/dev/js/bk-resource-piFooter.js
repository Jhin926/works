    ...
    require(['maintab', 'ZeroClipboard', 'ueditorLang', 'blockUI', 'jqform'], function (maintab, ZeroClipboard) {
        ...
        $("#new-tem").on('click', function () {
            ...
            $("#tem-add").on('click', function () {
                ...
                var dataEdit = '{"templateType":4,"keyValueType":' + '{"key":"","value":"' + name + '",valueI:"' + contentText + '","type":"1"}' + '}';
                if (name == '') {
                    $.Alert('请填写名称')
                } else {
                    $.ajax({
        ...
        $(document).on('click', '.temClose', function () {
            ...
            var dataEdit = '{"templateType":4,"keyValueType":' + '{"key":"' + id + '","value":"' + name + '",valueI:"' + contentText + '","type":"2"}' + '}';
        ...
        $(document).on('click', '.temEdit', function () {
            ...
            $("#tem-add").on('click', function () {
                ...
                contentText = contentText.replace(/"/g, "&#39;");
                var name = $("#tem-name").val();
                var dataEdit = '{"templateType":4,"keyValueType":' + '{"key":"' + id + '","value":"' + name + '",valueI:"' + contentText + '","type":"3"}' + '}';
                if (name == '') {
                    $.Alert('请填写名称')
                } else {
                    $.ajax({
