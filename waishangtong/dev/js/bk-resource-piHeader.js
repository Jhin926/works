    ...
    require(['maintab', 'ZeroClipboard', 'ueditorLang', 'blockUI', 'jqform'], function (maintab, ZeroClipboard) {
        ...
        $('[data-code]').each(function(){
            for(var i=0; i<funcList.length; i++){
                if(funcList[i].code == $(this).attr('data-code')){//有某个功能
        ...
        $("#new-tem").on('click', function () {
            ...
            $("#tem-add").on('click', function () {
                ...
                var dataEdit = '{"templateType":3,"keyValueType":' + '{"key":"","value":"' + name + '",valueI:"' + contentText + '","type":"1"}' + '}';
                if (name == '') {
                    $.Alert('请填写名称')
                } else {
                    $.ajax({
        ...
        $(document).on('click', '.temClose', function () {
            ...
            var dataEdit = '{"templateType":3,"keyValueType":' + '{"key":"' + id + '","value":"' + name + '",valueI:"' + contentText + '","type":"2"}' + '}';
        ...
        $(document).on('click', '.temEdit', function () {
            ...
            $("#tem-add").on('click', function () {
                ...
                contentText = contentText.replace(/"/g, "&#39;");
                var name = $("#tem-name").val();
                var dataEdit = '{"templateType":3,"keyValueType":' + '{"key":"' + id + '","value":"' + name + '",valueI:"' + contentText + '","type":"3"}' + '}';
                $.ajax({
                    url: Base.sitUrl + "/api/org/v1/org/template/edit",
                    type: "POST",
                    dataType: "json",
