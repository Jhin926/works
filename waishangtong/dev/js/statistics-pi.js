require([ 'common' ], function () {
    require(['maintab', 'blockUI', 'jqform'], function (maintab) {
        ...
        function money() {
            $.ajax({
                url: Base.sitUrl + '/api/pi/v1/pi/amount',
                type: 'GET',
                dataType: 'json',
        ...
        function chartData() {
            var dataJson;
            $.ajax({
                url: Base.sitUrl + '/api/pi/v1/pi/amount/count',
                type: 'GET',
                dataType: 'json',
                async: false,
                success: function (res) {
        ...
        function leftTop() {
            $.ajax({
                url: Base.sitUrl + '/api/pi/v1/pi/amount/sort',
                type: 'POST',
                dataType: 'json',
                data: {
        ...
        function rightTop() {
            $.ajax({
                url: Base.sitUrl + '/api/pi/v1/pi/amount/top',
                type: 'POST',
                dataType: 'json',
                success: function (res) {
                    if (!res.success) {
